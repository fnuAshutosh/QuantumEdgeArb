...
Complete all the tasks outlined in the .planning roadmap, starting with Phase 02 and progressing through Phase 05. Ensure each stub marked 🔴 or 🟡 in `PROMPT.md` is implemented and corresponding tests are written and passing.